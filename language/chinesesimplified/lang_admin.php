...
"manadjs_title" => "调整管理",
"manevents_title" => "事件管理",
"manitempools_title" => "物品池管理",
"mantasks_title" => "任务管理",
"manitems_title" => "物品管理",
"manmdkp_title" => "多DKP管理",
"manraid_title" => "Raid 管理",
"manrank_title" => "Rank Management",
"uc_last_updated" => "最后更新",
"uc_never_updated" => "从未更新",
"uc_bttn_update" => "刷新",
"uc_bttn_resetcache" => "清除缓存",
"uc_bttn_import" => "导入",
"plugins_title" => "插件管理",
"styles_title" => "风格管理",
"updraid_title" => "更新一个 Raid",
"viewlogs_title" => "日志查看器",
"clear_all_logs" => "清除全部日志",
"clear_last_logs" => "日志早于",
"filter_plugins" => "按插件过滤",
"filter_type" => "按类型过滤",
"days" => "days",
...
"logs" => "日志",
"manage_members" => "人物管理",
"manage_raids" => "Raid 管理",
"manage_user" => "用户管理",
"member_history" => "转移人物历史到",
...
"default_style_overwrite" => "覆盖用户风格设置 (每个用户使用默认风格)",
"class_colors" => "职业颜色",
"description" => "描述",
"manual" => "Manual",
"homepage" => "主页",
...
"pdc_entity" => "Entity",
"pdc_entity_valid" => "有效",
"pdc_entity_expired" => "已过期",
"pdc_size" => "大小",
"pdc_clear" => "清除",
"pdc_cleanup" => "清理",
"pdc_settings" => "缓存设置",
"pdc_table" => "缓存条目",
"pdc_cache_select_text" => "缓存选择",
"pdc_cache_select_info" => "Choose the system, which shall be used for caching.",
"pdc_dttl_text" => "设置默认 TTL [s]",
...
"puc_solve_dbissues" => "解决",
"lib_pupd_intro" => "新版本可用:",
...
"rssadmin_head1" => "通知",
"rssadmin_head2" => "Eqdkp-Plus 新闻",
"adminc_news" => "新闻",
"adminc_statistics" => "统计",
"adminc_server" => "PHP 信息",
"adminc_support" => "支持",
"adminc_phpvalue" => "值",
"adminc_phpname" => "PHP 设置名称",
...
"title_manageusers" => "管理用户",
"title_mysqlinfo" => "MySQL 信息",
"title_resetdkp" => "重置",
"portal" => "门户",
"plug_dep_title" => "依赖",
"plug_dep_plusv" => "Plus 版本",
"plug_dep_libsv" => "库版本",
"plug_dep_games" => "游戏支持",
"plug_dep_phpf" => "PHP 函数",
"plug_dep_plusv_short" => "Plus",
"plug_dep_libsv_short" => "库",
"plug_dep_games_short" => "游戏",
"plug_dep_phpf_short" => "PHP",
"plug_dep_broken_deps" => "Broken dependencies!",
"plug_tab_plugins" => "管理插件",
...
"uc_delete_manager" => "任务管理",
"uc_revoke_char" => "恢复人物",
"uc_delete_char" => "删除人物",
"uc_rewoke_char" => "恢复人物",
"uc_delete_allchar" => "全部删除",
"uc_confirm_all" => "全部确认",
...
"manage_user_groups" => "用户组管理",
"manage_user_group" => "用户组管理",
...
"manage_cronjobs" => "定时任务管理",
"repeat_interval" => "Repetition interval",
"last_run" => "最后执行",
"next_run" => "下一次执行",
"execute" => "执行",
"repeat" => "重复",
"cron_start_time" => "开始日期/时间",
...
"manage_calendars" => "日历管理",
"manage_calevents" => "日历条目管理",
...
"calendar_raid_nsfilter" => "在“未注册窗口”显示哪些人物，除了主要人物",
...
"calendar_addevent_mode" => "在事件创建时的默认选择",
...
"pk_tab_fs_chars" => "人物设置",
"pk_show_twinks" => "显示 twinks",
...
"pk_tab_fs_game" => "游戏设置",
"pk_tab_fs_importer" => "导入器设置",
"pk_defaultgamelang" => "游戏语言",
"pk_defaultgame" => "游戏",
...
"default_lang" => "默认语言",
"failed_logins_inactivity" => "禁用用户账号前的登入失败次数",
...
"custom_logo" => "DKP 系统的 Logo",
"custom_logo_help" => "Here you can change the logo of your DKP-System",
"default_alimit_help" => "每页调整数。",
"default_elimit_help" => "每页事件数。",
"default_ilimit_help" => "每页物品数。",
"default_nlimit_help" => "每页新闻数。",
"default_rlimit_help" => "每页 raids 数。",
"default_alimit" => "每页调整",
"default_elimit" => "每页事件",
"default_ilimit" => "每页物品",
"default_nlimit" => "每页新闻",
"default_rlimit" => "每页 raids",
...
"pk_tab_fs_globalsettings" => "全局设置",
"pk_tab_fs_cookie" => "Cookie 设置",
"pk_tab_fs_auth" => "认证设置",
"pk_tab_fs_email" => "Email",
"pk_tab_fs_recaptcha" => "ReCaptcha",
"pk_tab_fs_date" => "日期",
"default_date_time" => "时间格式",
"default_date_short" => "日期格式 (短)",
"default_date_long" => "日期格式 (长)",
"timezone" => "EQDKP-Plus 的默认时区",
...
"default_locale" => "默认区域 (只用于人物设置，不会影响语言)",
...
"pk_debug" => "EQDKP-PLUS 调试模式启用",
"pk_debug_help" => "If activated, EQdkp-Plus is in Debug-Mode, which provides additional information and error messages.",
"pk_set_debug_type0" => "调试关闭 (Debug=0)",
"pk_set_debug_type1" => "简单调试 (Debug=1)",
"pk_set_debug_type2" => "调试 SQL 查询 (Debug=2)",
"pk_set_debug_type3" => "扩展调试 (Debug=3)",
"pk_set_debug_type4" => "开发者模式 (Debug=4)",
"main_title" => "页面名称",
...
"pk_tab_itemtooltip" => "物品信息条",
"pk_tab_fs_itemtooltip" => "物品信息条",
"infotooltip_use" => "启用物品信息条",
"itt_debug" => "调试模式",
...
"pk_itt_force_default" => "重新载入默认值",
"pk_tab_fs_priorities" => "物品数据库优先级",
"itt_prio1" => "1. 搜索数据库",
...
"itt_icon_ext" => "图标文件扩展名。",
"itt_icon_ext_help" => "Usually .png or .jpg",
"itt_default_icon" => "默认图标",
...
"pk_tab_fs_ittdbsettings" => "物品数据库特定设置",
"pk_tab_fs_ittlanguages" => "语言优先级",
"pk_tab_sms" => "SMS",
...
"lm_page_viewmember" => "人物管理",
"lm_page_calendar" => "日历",
"lm_page_manage_characters" => "人物管理",
"lm_page_admin_manage_members" => "人物设置",
"lm_page_admin_manage_items" => "物品管理",
"lm_page_admin_manage_events" => "事件管理",
"lm_page_admin_manage_adjustments" => "调整管理",
"lm_page_admin_manage_raids" => "Raid 管理",
"lm_page_admin_manage_news" => "新闻设置",
"lm_page_admin_manage_roles" => "角色管理",
"lm_page_admin_manage_calevents" => "日历设置",
"lm_page_admin_manage_logs" => "日志设置",
"lm_page_admin_index" => "管理首页",
...
"massmail" => "群体邮件",
"massmail_to_user" => "发送到用户",
"massmail_to_group" => "发送到组",
...
"repo_hide_updatewarning" => "隐藏这个提示",
"repo_extensioninfo" => "Informationen to this Extension",
"thumbnail_defaultsize"	=> 'Lightbox 的默认缩略图宽度',
