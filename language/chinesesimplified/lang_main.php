...
"LANG_VERSION" => '1.0.7',
	...
	"listitems_title" => '物品价值',
	"listnews_title" => '新闻条目',
	"listmembers_title" => 'Character Standings',
	"listraids_title" => 'Raids 列表',
	"login_title" => '登入',
	"message_title" => 'EQdkp: 消息',
	"newsarchive_title" => '新闻存档',
	"register_title" => '注册',
	"settings_title" => '账号设置',
	...
	"email" => 'Email',
	"email_confirm" => '确认 email 地址',
	"email_address" => 'Email 地址',
	"ending_date" => 'Ending Date',
	"from" => '从',
	"language" => '语言',
	"password" => '密码',
	"remember_password" => '记住我 (cookie)',
	"starting_date" => '开始日期',
	"style" => '样式',
	"to" => '到',
	"users" => '用户',
	...
	"no_connected_char" => '你没有已链接的人物。点击以创建一个人物。',
	...
	"no_connected_char_hide" => '点击这里永久隐藏这条消息。',
	"user_list" => '用户列表',
	"user_priv" => '隐私',
	"info_edit_user" => '最近更改:',
	"info_edit_date" => '/',
	...
	"portalplugin_settings" => '设置',
	"portalplugin_winname" => '门户模块设置',
